                        ...
                        <div class="row">
                            <div class="col-3">
                                <form action="<?php echo base_url() ?>Employee/Employeeinsertupdate" method="post" autocomplete="off">
                                    ...
                                    <div class="form-group mb-1">
                                        <label class="small font-weight-bold">Employee Contact*</label>
                                        <input type="text" class="form-control form-control-sm" name="contact" id="contact" required>
                                    </div>
                                    <div class="form-group mb-1">
                                        <label class="small font-weight-bold">Employee E-mail*</label>
...
<script>
    $(document).ready(function() {
        ...
        $('#dataTable').DataTable({
            ...
            "buttons": [
                { extend: 'csv', className: 'btn btn-info btn-sm', title: 'Employee Information', text: '<i class="fas fa-file-csv mr-2"></i> CSV', },
                { extend: 'pdf', className: 'btn btn-primary btn-sm', title: 'Employee Information', text: '<i class="fas fa-file-pdf mr-2"></i> PDF', },
                { 
                    extend: 'print', 
            ...
            ajax: {
                url: "<?php echo base_url() ?>scripts/employee.php",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        var button='';
                        button+='<button class="btn btn-info btn-sm btnEdit mr-1 ';if(editcheck!=1){button+='d-none';}button+='" id="'+full['idtbl_employee']+'"><i class="fas fa-pen"></i></button>';
                        if(full['status']==1){
                        ...
                        button+='<a href="<?php echo base_url() ?>Employee/Employeestatus/'+full['idtbl_employee']+'/3" onclick="return delete_confirm()" target="_self" class="btn btn-primary btn-sm ';if(deletecheck!=1){button+='d-none';}button+='"><i class="fas fa-trash-alt"></i></a>';
