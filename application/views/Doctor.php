            ...
            "columns": [ 
                ...
                
                {
                    ...
                    "render": function(data, type, full) {
                        var button='';
                        button+='<button class="btn btn-info btn-sm btnEdit mr-1 ';if(editcheck!=1){button+='d-none';}button+='" id="'+full['idtbl_doctor']+'"><i class="fas fa-pen"></i></button>';
                        if(full['status']==1){
                        ...
                        button+='<a href="<?php echo base_url() ?>Doctor/Doctorstatus/'+full['idtbl_doctor']+'/3" onclick="return delete_confirm()" target="_self" class="btn btn-primary btn-sm ';if(deletecheck!=1){button+='d-none';}button+='"><i class="fas fa-trash-alt"></i></a>';
