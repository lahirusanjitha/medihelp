                                ...
                                <form action="<?php echo base_url() ?>User/Userprivilegeinsertupdate" method="post" autocomplete="off">
                                    <div class="form-group mb-1">
                                        ...
                                        <select type="text" class="form-control form-control-sm" name="userlist" id="userlist" required>
                                            ...
                                            <option value="<?php echo $rowuseraccount->idtbl_res_user ?>"><?php echo $rowuseraccount->name ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group mb-1">
                                        ...
                                        <select type="text" class="form-control form-control-sm" name="menulist[]" id="menulist" required multiple>
                                            ...
                                            <option value="<?php echo $rowmenulist->idtbl_res_menu_list ?>"><?php echo $rowmenulist->menu ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
        ...
        $('#dataTable').DataTable( {
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        var button='';
                        button+='<button class="btn btn-info btn-sm btnEdit mr-1 ';if(editcheck==0){button+='d-none';}button+='" id="'+full['idtbl_user_privilege']+'"><i class="fas fa-pen"></i></button>';
                        if(full['status']==1){
                        ...
                        button+='<a href="<?php echo base_url() ?>User/Userprivilegestatus/'+full['idtbl_user_privilege']+'/3" onclick="return delete_confirm()" target="_self" class="btn btn-primary btn-sm ';if(deletecheck==0){button+='d-none';}button+='"><i class="far fa-trash-alt"></i></a>';
