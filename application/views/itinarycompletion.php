            ...
            "columns": [
                ...
                
                {
                    ...
                    "render": function(data, type, full) {
                       ...
                       if(full['confirmation']==1){
                            button+='<a href="<?php echo base_url() ?>ItinaryCompletion/ItinaryCmpletionStatus/'+full['idtbl_job_list']+'/1" onclick="return complete_confirm()" target="_self" class="btn btn-success btn-sm mr-1 ';
                            if(statuscheck!=1)
                            {
                                button+='d-none';
                            }
