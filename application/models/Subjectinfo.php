<?php
class Subjectinfo extends CI_Model{
    public function Getsubject(){
        $this->db->select('`tblid_subject`,`subject`');
    ...
    public function Subjectinsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->where('tblid_subject', $recordID);
    ...
    public function Subjecteidt(){
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->tblid_subject;
        $obj->subject=$respond->row(0)->subject;
